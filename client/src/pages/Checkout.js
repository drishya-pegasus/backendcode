...
const couponCodes = [ 'IAMASTUDENT'];

const Checkout = () => {
  const sizes = ['Cash On Delivery', 'Fonepay'];
              ...
              <div className="card-body">
                <form>
                  ...
                  {selectedPaymentMethod !== 'Cash On Delivery' && (
                    <div className="mb-3">
                      <label htmlFor="file" className="form-label">Attach Payment Screenshot (if applicable)</label>
                  ...
                  <div className="form-check">
                    <input 
                      ...
                      className="form-check-input" 
                    />
                    <label htmlFor="terms" className="form-check-label">I agree to the terms and conditions of Bello. <br/> The information I have provided above is correct. <br/></label>
                  </div>
                  <button 
                    type="submit" 
                  ...
                  />
                    ...
                    <div className="col-md-8">
                      <div className="card-body">
                        ...
                        <p className="card-text">Price: Rs.{customPrice(item.productId, item.size) * item.quantity}/-</p>
                        <button
                          className="delbut"
...
<Modal visible={isModalVisible} onCancel={handleModalClose} footer={null}>
        {selectedPaymentMethod === 'Fonepay' && (
          <img src={pay} alt="Fonepay"  width='100%' height='100%'/>
        )}
</Modal>
    </Layout>
  );
